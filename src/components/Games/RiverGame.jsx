...
import goldenImg from "../../assets/sprites/river-game-sprites/goldenfish.png";
import rainbowImg from "../../assets/sprites/river-game-sprites/rainbowfish.png";
...
export default function RiverGame() {
  ...
  const INTRO_DIALOGUE = [
    ...
    { speaker: "Bear", text: "Build a trash combo for bonus points, and catch as many fish as you can. Pay attention for special rainbow and golden fish that are worth more points! Good luck!" },
  ];
